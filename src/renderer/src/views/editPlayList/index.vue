<template>
  <div class="editPlayList">
    ...
    <div class="main">
        ...
        <div class="img">
            <el-image style="width: 150px; height: 150px"  :src="Main.playList[index].coverImgUrl"></el-image>
  ...
  <MyDialog :flag="picFlag" confirmName="保存并关闭" cancelName="重新选择" @confirm="confirm" @cancel="cancel" @close-dialog="closeDialog">
    <template #header>
        <div class="title">编辑歌单封面</div>
    </template>
    <template #midle>
        <div class="img-pick">
            <div class="left">
