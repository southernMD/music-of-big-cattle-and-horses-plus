    ...
    <div class="MusicRadio" :class="{ 'MusicRadio-oneself': globalVar.oneself == 1 }">
        ...
        <div class="readioOption">
            <div class="top" ref="top">
                ...
                <div class="start">
                    <div class="bk" :class="{'bk-oneself':globalVar.oneself == 1}" @click="changPlayStatus" :title="`${stopOrPlayFlag ? '继续' : '暂停'}（Ctrl + P）`">
            ...
            <div class="bottom" :class="{'bottom-oneself':globalVar.oneself == 1}">
                ...
                <div class="audio-line" ref="audio-line" :class="{'audio-line-oneself':globalVar.oneself == 1}" @click="clickAudioPlay">
                    <div class="line-loading" ref="line-loading" :class="{'line-loading-oneself':globalVar.oneself}" v-show="playingList.length"></div>
